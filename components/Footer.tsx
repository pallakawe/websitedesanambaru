    ...
    return (
        <footer className="bg-primary text-primary-foreground py-12 mt-16">
            <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    ...
                    <p className="opacity-80 max-w-sm">
                        Website resmi desa Nambaru sebagai pusat informasi publik dan pelayanan masyarakat yang transparan dan akuntabel.
                    </p>
                </div>
                <div>
                    ...
                    <ul className="space-y-2 opacity-80">
                        ...
                        <li><a href="/umkm" className="hover:underline hover:opacity-100 transition">UMKM Desa</a></li>
                    </ul>
                </div>
                <div>
                    <h4 className="text-lg font-semibold mb-4">Kontak Kami</h4>
                    <address className="opacity-80 not-italic space-y-2">
                        <p>Kantor Kepala Desa Nambaru</p>
            ...
            <div className="text-center mt-12 pt-8 border-t border-primary-foreground/20 opacity-60 text-sm">
                &copy; {new Date().getFullYear()} Pemerintah Desa Nambaru. Dikelola oleh KKN.
            </div>
        </footer>
    );
}
